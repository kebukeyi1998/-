			...
			<block v-for="(item, _index) in timeArr" :key="_index">
				<view class="item">
					...
					>
						...
						<!--
						<text class="all" v-if="_index == timeActive[0] && !item.disable" style="font-size: 6upx;">开始时间</text>
						<text class="all" v-if="_index == timeActive[1] && !item.disable" style="font-size: 6upx;">结束时间</text>
					    -->
					</view>
				</view>
			</block>
